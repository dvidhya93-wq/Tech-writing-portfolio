...
I hold a Bachelor’s degree in Aeronautical Engineering from Anna University, Chennai. I previously worked at Capgemini and now work at Boring as a Technical Writer, where I create and update User Guides, Administrator Guides and Release Notes.

Independently developed a multi-domain documentation portfolio demonstrating end-to-end documentation across API references, developer guides, and software user guides:
...
workflows, feature walkthroughs, and step-by-step instructions tailored for non-technical audiences.
